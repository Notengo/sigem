...
<?php  echo "Usuario: ".$_SESSION['usuario_nombre']." ".$_SESSION['usuario_apellido'];
$tabindex=1;
?>    
</div>
<fieldset>            
    ...
    <div  align="right" style="margin: 5px;"  >
        Fecha Ingreso: <?php echo $fechaIng; ?>   
    <?php 
    ...
    <?php $tabindex++; ?>    
    <input type="text" id="codeq" name="codeq" 
           value="<?php if(isset($codeqD)) echo $codeqD; ?>" onKeyUp="ajax_showOptionsNomencl(this,'getCodeqByLetters',event)"
           size="65" onFocus="this.style.color='blue'" onBlur="this.style.color='#333333';" tabindex="<?php echo $tabindex;?>" />*
    ...
    $tabindex++; ?>  
    Alimentaci&oacute;n:<select name="alimentacion" id="alimentacion" tabindex="<?php echo $tabindex;?>" >
    ...
    <input type="text" id="edad" name="edad" value="<?php if(isset($edad)) echo calculaedad($edad); ?>" size="5" onFocus="this.style.color='blue'" onBlur="this.style.color='#333333'" tabindex="<?php echo $tabindex;?>" />&nbsp;<cite style="font-size: 12px">a&ntilde;os</cite>
    <br/> 
    <?php $tabindex++; ?>        
    ...
    if($nombre<>'') { 
        ...
        mostrarCategorias("servicio",0,$aServicio,"getId", "getDescripcion", $tabindex);       
        $tabindex++; ?>    
        Sala: <input type="text" id="subservicio" name="subservicio" value="<?php echo $subservicio ?>" size="15" tabindex="<?php echo $tabindex;?>"/>
        <br/> 
    <?php }  $tabindex++; ?>       
        
    <label for="adquiriente" class="detalle">Adquiriente:</label>    
    <input type="text" id="adquiriente" name="adquiriente" value="<?php echo $adquiriente ?>" onKeyUp="ajax_showOptionsAdquiriente(this,'getAdquirienteByLetters',event)" size="65" onFocus="this.style.color='blue'" onBlur="this.style.color='#333333'" tabindex="<?php echo $tabindex;?>"/>
    ...
    <cite style="font-size: 12px">Desde&nbsp;</cite><input type="text" id="garantiaDesde" name="garantiaDesde" value="<?php echo $garantiaDesde; ?>" size="10" tabindex="<?php echo $tabindex;?>" placeholder="dd/mm/aaaa" onblur="validar_fecha(this);" onkeypress="ver(this);"/>
    <cite style="font-size: 12px">Hasta&nbsp;</cite><input type="text" id="garantiaHasta" name="garantiaHasta" value="<?php echo $garantiaHasta; ?>" size="10" tabindex="<?php echo $tabindex;?>" placeholder="dd/mm/aaaa" onblur="validar_fecha(this);" onkeypress="ver(this);"/>    
    <br/>
    <?php $tabindex++; ?>        
    <label for="oficina" class="detalle">Proveedor:</label>    
    <input type="text" id="proveedor" name="proveedor" value="<?php echo $proveed?>" onKeyUp="ajax_showOptionsProveedor(this,'getProveedorByLetters',event)" size="65" onFocus="this.style.color='blue'" onBlur="this.style.color='#333333'" tabindex="<?php echo $tabindex;?>" />
