...
if(empty($_POST['ofcodi'])) {
    ...
    if($oMysqlEquipo->find($oEquipo)==false) {
        ?><br/>
            <center>
                <div id='flotante'>
                <div class='info' style=" width: 450px; border: 1px solid #369; color: #369;">                                        
                    Se asoció a la orden de trabajo un nro de equipo aún no registrado 
                    <br/>                                       
                    <br/>                    
                </div>
                </div>               
        ...
        <?php
        $oOrden->setNroEquipo($_POST['nroEquipo']);
        $oOrden->setEquipo(0);
    } else {
