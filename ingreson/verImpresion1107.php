...
<div id="informe">
 <div style="display: block; margin-left:30px; text-align: center; font-weight: bold; font-size: 15px;border: 1px solid #000;  margin-left:35px; margin-right:35px;  padding: 10px;  padding-right: 25px;  font-family: Calibri, Arial, Helvetica, sans-serif;" >
     ...
     <div style="clear:both; min-height: 260px;border-top: 1px solid; font-size: 12px; display: block; margin: auto; text-align: left; font-weight: normal; padding: 10px; line-height: 20px; font-family: Calibri, Arial, Helvetica, sans-serif;">         
         ...
         <?php 
            ...
            if(($oOrden->getEquipo()<>'0')&&($oOrden->getEquipo()<>NULL))  {
                echo " <strong>".$oOrden->getEquipo()."</strong>  <div style='margin-left:50px; line-height: 14px;'>"; 
         ...
         <?php 
            ...
            ?>
     <br/><u>Resolución:</u>&nbsp;&nbsp;&nbsp;______________________________________________________________<br/>
