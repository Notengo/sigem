    ...
    <table class="formulario">
        <tbody>
            ...
            <tr>
                ...
                <td><strong><?php echo html_entity_decode($oOrden->getDescripcion())?></strong></td>
            </tr>                     
            <?php
        ...
        <tfoot>
            <tr>
                <td colspan="2">                    
                    <input name="regresar" type="button" id="Regresar" value="&nbsp;&nbsp;&nbsp;Regresar&nbsp;&nbsp;&nbsp;" onclick="location.href='index.php'" class="button"/>
                </td>
            </tr>
        </tfoot>
    </table>
