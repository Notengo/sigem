...
<h1>Agregando nuevo Servicio</h1>
...
<form action="javascript: fn_agregar();" method="post" id="frm_per">
    <table class="formulario">
        <tbody>
            <tr>
                <td>Servicio</td>
                <td><input name="servicio" type="text" id="servicio" size="50" class="required" />*</td>
            </tr>                   
        </tbody>
        <tfoot>
            <tr>
...
<script language="javascript" type="text/javascript">	
		...
		$("#frm_per").validate({
			...
			submitHandler: function(form) {
				var respuesta = confirm('\xBFDesea realmente agregar el servicio?')
				if (respuesta)
					form.submit();
			}
		});
