...
$sql = "SELECT * FROM servicio as s WHERE s.fechaBaja='0000-00-00 00:00:00' ";
if($_GET['criterio_usu_per']<>'') {
        $sql .= " AND s.descripcion like '%".fn_filtro(substr(utf8_decode($_GET['criterio_usu_per']), 0, 16))."%'  ";    
}
    ...
    <table id="grilla" class="lista" width="1000px">
        <thead>
            ...
            <tr>                
                ...
                <td>
                    <a href="javascript: fn_mostrar_frm_modificar(<?=$rs_res['idServicio']?>);"><img src="../css/img_estilos/page_edit.png" /></a>
                    <a href="javascript: fn_eliminar(<?=$rs_res['idServicio']?>);"><img src="../css/img_estilos/cancela.png" /></a>
                </td>            
            </tr>
        <?php } ?>        
        </tbody>
