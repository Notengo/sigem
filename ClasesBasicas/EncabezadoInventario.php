   ...
   <div id="header">
      ...
      <ul>
        ...
        <?php
         ...
         ?>
         <li ><a href="<?php echo '../inventario/index.php'; ?>" ><span>Inventario</span></a></li>   
         <?php         
         if (!(isset($_SESSION['usuario_login']) || isset($_SESSION['usuario_password'])))
         {
            ...
            if ($_SESSION['usuario_nivel']=='Z')
               echo '<li id="current"><a href="../usuarios/index.php" target="_self"><span>Administrador</span></a></li>';
            else
               echo '<li id="current"><a href="../usuarios/index.php" target="_self"><span>Administracion</span></a></li>';
         }
         ?>
    ...
    <?php
    include_once("../menu_horizontal_inventario.php");
    ?>
</div>
</body>
</html>