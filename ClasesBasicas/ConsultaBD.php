...
class ConsultaBD   // se declara una clase para poder ejecutar las consultas, esta clase llama a la clase conexion
{
    ...
    public function Conectar($base='sigem') {
    ...
    public function executeQuery($cons)  {
        //$this->consulta= mysql_query($cons,$this->conexion->getConexion()) or die ("<div class=error style='text-align: center'>Ha ocurrido un error ejecutando la consulta</div>");
        $this->consulta= mysql_query($cons,$this->conexion->getConexion()) or die (mysql_error());
