...
function fn_mostrar_frm_agregar(idAccion){
	$("#div_oculto").load("ajax_form_agregar.php", {idAccion: idAccion}, function(){
		$.blockUI({
			message: $('#div_oculto'),
			css:{
				top: '20%'
...
function fn_eliminar(ide){
    var respuesta = confirm("Realmente esea eliminar el objeto?");
    if (respuesta){
        $.ajax({
